addModule('commentPreview', function(module, moduleID) {
	...
	module.exclude = [
		/^https?:\/\/(?:[\-\w\.]+\.)?discussion\.mit\.edu\/(?:r\/[\-\w\.]+\/)?wiki\/edit\/config\/automoderator\b/i
	];
	...
	module.go = function() {
		if ((this.isEnabled()) && (this.isMatchURL())) {
			...
			isBan = /^https?:\/\/(?:[\-\w\.]+\.)?discussion\.mit\.edu\/r\/[\-\w\.]+\/about\/banned/i.test(document.location.href);
	...
	function attachPreview(usertext) {
		...
		$(usertext).find('.usertext-edit, .ban-details:has(#ban_message)').each(function() {
			...
			if (/^https?:\/\/(?:[\-\w\.]+\.)?discussion\.mit\.edu\/r\/[\-\w\.]+\/about\/edit/i.test(document.location.href) &&
					!module.options.enableForSubredditConfig.value) {
				return;
			}

			if (/^https?:\/\/(?:[\-\w\.]+\.)?discussion\.mit\.edu\/r\/[\-\w\.]+\/about\/banned/i.test(document.location.href) &&
