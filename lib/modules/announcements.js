addModule('MDESAnnouncements', function(module, moduleID) {
	module.moduleName = 'MDES Announcements';
	module.category = 'Core';
	module.description = 'Keep up with important news';
	module.disabledByDefault = true;

	var sourceUrl = 'r/enhancement/new.json?limit=1&app=res';
	var viewUrl = '/r/enhancement/new';
